    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a href="{{ route ('employer.create') }}" class="btn btn-primary rounded-pill">Add New Employer</a>
                <br><br>
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('employer.edit', $employer) }}" class="btn btn-secondary rounded-pill float-start me-3">Edit</a>
